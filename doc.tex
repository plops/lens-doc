...
\begin{figure}[!hbt]
  ...
  \caption{Raytracing through an objective followed by a tubelens. The
    ...
    into an unscaled image.}
\end{figure}

For an objective focal length of \unit[2.61]{mm}, a tubelength of
\unit[160]{mm}, an immersion index of $n=1.52$ and an embedding index
of $n_e=1.33$ the raytracing simulation gives the following results:
\begin{figure}[!hbt]
  \centering
