...
\item construct the tangents on the out of focus nucleus by intersecting a sphere around $\c$ with radius $R=\abs{\c-\s}$ and the sphere of the out of focus nucleus centered at $\s$ with radius $r$   
\end{itemize}
\begin{align}
  (x-R)^2+y^2&=R^2\\
  x^2+y^2=r^2
\end{align}
 \begin{figure}[!hbt]
   ...
   \caption{Schematic of how an out of focus nucleus with radius $r$
     centered at $\s$ and an in focus target point $\c$ define a cone
     of rays.}
 \end{figure}
\end{document}
